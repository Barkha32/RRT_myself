...
const Cart = () => {
  ...
  //const carttotalItems = useSelector(state => state.cart.totalQuantity);
      ...
      let total = Number(cartItems.reduce((a, b) => a + b.totalprice, 0));
     

     let shippingCharges = Number(!total === 0 && total < 20 ? 5 : 0);
      let tax = (total * 5) / 100;

      let checkoutPrice = Number(total + shippingCharges + tax);
